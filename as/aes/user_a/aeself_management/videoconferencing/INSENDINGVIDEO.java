	...
	implements  Serializable
{
	...
	{
		vInitiatedByEvents.add( generatedbyassl.as.aes.user_a.events.MEETINGSESSIONENDEDINSTANTMEETING.getInstance() );
		...
		vInitiatedByEvents.add( generatedbyassl.as.aes.user_a.events.MEETINGSESSIONENDEDSCHEDULEDMEETING.getInstance() );
		...
		vTerminatedByEvents.add( generatedbyassl.as.aes.user_a.events.VIDEOUSER_ASENT.getInstance() );
		generatedbyassl.as.aes.user_a.events.VIDEOUSER_ASENT.getInstance().addEventCatcher(this); //**** fluent registers for that event
	}
