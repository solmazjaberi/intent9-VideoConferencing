	...
	implements  Serializable
{
	...
	public boolean GUARDS (  )
	{
		...
		bResult =  generatedbyassl.as.aes.user_a.aeself_management.self_configuring.INREQUEST_A.getInstance().isFluentInitiated()  ;
		return bResult;
	}
	...
	{
		super.DOES();
		generatedbyassl.as.asip.functions.SENDREQUESTMSG.getInstance().perform( "User_A" );
		generatedbyassl.as.asip.functions.RECEIVEREQUESTMSG.getInstance().perform( "User_A" );
	}
