	...
	implements  Serializable
{
	...
	{
		generatedbyassl.as.aes.controller.aeip.messages.MSGINSTANTMEETINGEND_A.getInstance().addMsgCatcherReceivedEvent(this);
	}
	...
	protected void checkEventConditions (  )
	{
		...
		if (  isMessageReceived(generatedbyassl.as.aes.controller.aeip.messages.MSGINSTANTMEETINGEND_A.getInstance())  ) 
		{
			triggerEvent();
		}
